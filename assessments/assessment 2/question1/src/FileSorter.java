...
public class FileSorter implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (line != null) {
                ...
                System.out.println("Split Progress = " + splitProgress);
                if (lines.size() == limit) {
    ...
    public double getMergeProgress() {
       return mergeStage.getMergeProgress();
    }
    ...
    public static void main(String[] args) {
        FileSorter f = new FileSorter(10, new File("D:\\Github\\COMP610\\COMP610-Data-Structures-and-Algorithm\\assessments\\assessment 2\\question1\\cities.txt"), new File("citiesOutput.txt"));
        f.run();
